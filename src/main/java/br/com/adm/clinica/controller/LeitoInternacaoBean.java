...
import br.com.adm.clinica.model.builder.LeitoInternacaoBuilder;
...
public class LeitoInternacaoBean implements Serializable {
	...
	public void salvar(Long id) {
		...
		FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO,
				"Leito de internação Cadastrado Com Sucasso", "Leito de internação Cadastrado Com Sucasso"));
	}
	...
	public void InternarPaciente() throws ParseException {
		...
		FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO,
				"Paciente Internado Com Sucesso", "Paciente Internado Com Sucesso"));
		nomePaciente = "";
	}
	...
	public void deletar(Long id) {
		...
		FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO,
				"Leito de internação Deletado Com Sucasso", "Leito de internação Deletado Com Sucasso"));
	}
	...
	public void showLeitoInternacaoDesocupado(Leito leito) throws IOException {
		...
		FacesContext.getCurrentInstance().getExternalContext()
				.redirect("listarleitointernacaodesocupado.xhtml?faces-redirect=true");
	...
	public void showLeitoInternacaoOcupado(Leito leito) throws IOException {
		...
		FacesContext.getCurrentInstance().getExternalContext()
				.redirect("listarleitointernacaoocupado.xhtml?faces-redirect=true");
	}
